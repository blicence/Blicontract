...
import {Faucet} from "./../../contracts/fortest/Faucet.sol";
import {MockERC20} from "./../../contracts/fortest/MockERC20.sol";
...
contract FaucetTest is BaseSetup {
    ...
    function test_drip_transferToDev() public {
        ...
        console.log("dev balance after Drip: ", _devBalAfterDrip);
        console.log("_inititalDevBal balance after Drip: ", _inititalDevBal);
